...
**Version:** 1.0.0`,
        ...
        try {
            ...
            const hints = errorHelper_1.ErrorHelper.addEngineeringHints('pressure_drop', {
            ...
            const hints = errorHelper_1.ErrorHelper.addEngineeringHints('pressure_drop', {
                reynolds: error?.reynoldsNumber,
                relativeRoughness: error?.relativeRoughness,
                diameter: error?.pipeDiameter,
                velocity: error?.flowVelocity,
            });
