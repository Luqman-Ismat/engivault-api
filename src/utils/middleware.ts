...
import { createRequestLogger, sanitizeRequestData, RequestLogContext } from './logger';
...
export function getRequestContext(request: FastifyRequest): RequestContext | null {
