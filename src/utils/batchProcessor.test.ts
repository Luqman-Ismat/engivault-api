...
import { processBatchOrSingle, isBatchRequest, isSingleRequest } from './batchProcessor';
...
describe('Batch Processor', () => {
  ...
  describe('processBatchOrSingle', () => {
    it('should process single item request', async () => {
      ...
      const result = await processBatchOrSingle(singlePayload, mockCalculator, mockReply);
    ...
    it('should process batch request with all valid items', async () => {
      ...
      const result = await processBatchOrSingle(batchPayload, mockCalculator, mockReply);
    ...
    it('should handle calculator throwing non-Error objects', async () => {
      ...
      const result = await processBatchOrSingle(batchPayload, calculatorWithStringError, mockReply);
