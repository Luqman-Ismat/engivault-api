 ...
 */
export function cavitationMargin(npshAvailable: number, npshRequired: number): number {
 ...
 */
export function calculateCavitationRisk(input: NPSHCalculationInput): CavitationRiskResult {
 ...
 */
export function validateNPSHInputs(input: NPSHCalculationInput): { isValid: boolean; errors: string[] } {
  const errors: string[] = [];
 ...
 */
export function resolveAtmosphericPressure(input: NPSHCalculationInput): NPSHCalculationInput {
